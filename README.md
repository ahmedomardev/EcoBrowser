...
- **Advanced Tab Management & Bookmarks:** Seamlessly manage tabs and save, organize, or quickly open your favorite sites using built-in bookmarks and a dynamic bookmarks bar.
...
- **Built-in Adult Content Blocker:** Automatically filters and blocks adult/explicit content domains and keywords for a safer browsing experience.
- **Comprehensive Downloads Experience:** Added an interactive downloads popup bubble and full downloads manager dialog to easily monitor, open, or manage downloaded files.
- **Persistent Preferences:** Automatically saves dark/light mode preferences and content blocker states to disk (`settings.json`).
